...
function exf.draw()
    ...
    love.graphics.print("Shall I Kill Her:", 260, 50)

    love.graphics.setFont(exf.mediumfont)
    love.graphics.print("Un hombre atormentado por oscuros sentimientos de debate", 140, 140)
    love.graphics.print("entre el bien y el mal. Debe tomar la decisión entre matar o no a ", 120, 160)
    love.graphics.print("su actual pareja. Para ello recorre sus recuerdos en busca de una razón.", 95, 180)
    exf.list:draw()

    love.graphics.setColor(255, 255, 255)
    love.graphics.draw(exf.bigball, 520 - 128, 600 - 128, love.timer.getTime(), 1, 1, exf.bigball:getWidth() * 0.5, exf.bigball:getHeight() * 0.5)
  end)
end
...
function exf.resume()
  ...
  love.window.setTitle("Shall I Kill Her")
	...
	-- create shadow bodys
	circleTest = lightWorld:newCircle(520 - 128, 600 - 128, exf.bigball:getWidth()*0.5)
end
